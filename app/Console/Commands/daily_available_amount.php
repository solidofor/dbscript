...
class daily_available_amount extends Command
{
    ...
    {
        try {
            log_and_dump('info','+++++++++++++++ Starting Daily available_amount RUN ++++++++++++++');
            ...
            foreach ($users as $user) {
                ...
                //     ->inRandomOrder()->get();
                    ...
                    $transactions = DB::connection('mysql2')->table('transactions')
                        ->where('clientid',$user->trxnkey)
                        ->whereBetween('trxndate', [Carbon::now()->startOfDay()->subDay(1), Carbon::now()->endOfDay()->subDay(1)])
            ...
            log_and_dump('info','+++++++++++++++ Ending Daily available_amount RUN ++++++++++++++');
